...
VALUES ('20190115153442_Initial', '2.2.1-servicing-10028');

ALTER TABLE `Assignments` DROP FOREIGN KEY `FK_Assignments_Students_StudentId`;

ALTER TABLE `Students` DROP FOREIGN KEY `FK_Students_AspNetUsers_UserId`;

ALTER TABLE `Students` MODIFY COLUMN `UserId` varchar(255) NOT NULL;

ALTER TABLE `Students` MODIFY COLUMN `LastName` longtext NOT NULL;

ALTER TABLE `Students` MODIFY COLUMN `FirstName` longtext NOT NULL;

ALTER TABLE `Classes` MODIFY COLUMN `Name` longtext NOT NULL;

ALTER TABLE `Assignments` MODIFY COLUMN `Title` longtext NOT NULL;

ALTER TABLE `Assignments` MODIFY COLUMN `StudentId` int NULL;

ALTER TABLE `Assignments` MODIFY COLUMN `Description` longtext NOT NULL;

ALTER TABLE `Assignments` ADD CONSTRAINT `FK_Assignments_Students_StudentId` FOREIGN KEY (`StudentId`) REFERENCES `Students` (`Id`) ON DELETE RESTRICT;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20190122100318_Validation', '2.2.1-servicing-10028');

ALTER TABLE `Assignments` MODIFY COLUMN `Description` longtext NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20190122150804_DescriptionOptional', '2.2.1-servicing-10028');
